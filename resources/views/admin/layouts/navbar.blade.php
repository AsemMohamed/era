            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview {{ active_menu('admin')[0] }}">
                    ...
                    <ul class="treeview-menu" style="{{ active_menu('admin')[1] }}">
                        <li class="active"><a href="{{ url('admin/admins') }}"><i class="fa fa-users"></i>{{ trans('admin.admin') }}</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview {{ active_menu('products')[0] }}">
                    <a href="#">
                        <i class="fa fa-shopping-cart"></i> <span>{{ trans('admin.products') }}</span>
                        <span class="pull-right-container"></span>
                    </a>
                    <ul class="treeview-menu" style="{{ active_menu('products')[1] }}">
                        <li class="active"><a href="{{ aurl('products') }}"><i class="fa fa-users"></i>{{ trans('admin.products') }}</a></li>
                    </ul>
                </li>
            </ul>
        </section>
