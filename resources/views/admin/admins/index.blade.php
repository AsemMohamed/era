            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-danger">
                        ...
                        <div class="not_empty_record hidden">
                            <h4>{{ trans('admin.ask_delete_item') }} <span class="record_count">5</span>?</h4>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <div class="not_empty_record hidden">
                        ...
                        <input type="submit" name="del_all" value="{{ trans('admin.yes') }}" onsubmit="" class="btn btn-danger del_all">
                    </div>
                </div>
            </div>
